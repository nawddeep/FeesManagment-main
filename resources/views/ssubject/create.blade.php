<x-layout.default>
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <h5 class="font-semibold text-lg dark:text-white-light">Add New Competition Subject</h5>
            <a href="{{ route('ssubject.index') }}" class="btn btn-outline-primary">
        ...
        <!-- Subject Form -->
        <form class="space-y-5" method="POST" action="{{ route('ssubject.store') }}">
            @csrf
