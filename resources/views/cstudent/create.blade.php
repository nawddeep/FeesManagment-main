<x-layout.default>
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <h5 class="font-semibold text-lg dark:text-white-light">Add New Competition Student</h5>
        ...
        <!-- Student Form -->
        <form class="space-y-5" method="POST" action="{{ route('cstudent.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <select name="competition_level" id="competition_level" class="form-select">
                    ...
                    <option value="District" {{ old('competition_level') == 'District' ? 'selected' : '' }}>District</option>
                    <option value="State" {{ old('competition_level') == 'State' ? 'selected' : '' }}>State</option>
                    <option value="National" {{ old('competition_level') == 'National' ? 'selected' : '' }}>National</option>
                    <option value="International" {{ old('competition_level') == 'International' ? 'selected' : '' }}>International</option>
                </select>
            </div>
            ...
            <!-- Subjects Selection -->
                <div>
                    ...
                    <select name="subject_dropdown" id="subject_dropdown" class="form-select mt-2">
                        <option value="">-- Select Subject --</option>
                        @foreach($ssubjects as $subject)
